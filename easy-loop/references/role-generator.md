...
- If the envelope's `milestone` field is set, implement only that milestone; leave later ones for their own rounds, and do not regress a milestone already passing.
